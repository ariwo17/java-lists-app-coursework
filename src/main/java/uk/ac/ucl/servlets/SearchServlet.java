...
public class SearchServlet extends HttpServlet
{
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    List<ItemList> searchResult = model.getItemListsBySubstring(request.getParameter("searchstring"));
    request.setAttribute("itemListResult", searchResult);
    List<Item> itemSearchResult = model.getItemsBySubstring(request.getParameter("searchstring"));
    request.setAttribute("itemResult", itemSearchResult);
